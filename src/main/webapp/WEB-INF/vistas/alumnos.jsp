...
<%@ include file="headerBody.jsp" %>
       ...
       <tbody class="bg-light">
		...
		<form action="cursosDelAlumno">
		<input type=hidden name="idAlumno" id="idAlumno" value="${alumno.getId()}">
   	    <td scope="col"><button type="submit" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book-half" viewBox="0 0 16 16">
		...
		<input type=hidden name="eliminarAlumno" id="eliminarAlumno" value="${alumno.getId()}">
