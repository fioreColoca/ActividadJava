...
CREATE TABLE `cursada` (
  ...
  KEY `FKjk47c9v61nvt1qux7lf7pnew1` (`curso_id`),
  CONSTRAINT `FKjk47c9v61nvt1qux7lf7pnew1` FOREIGN KEY (`curso_id`) REFERENCES `curso` (`id`),
...
INSERT INTO `cursada` VALUES (1,1,1);
